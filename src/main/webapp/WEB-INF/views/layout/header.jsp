			...
			<c:choose>
				<c:when test="${empty sessionScope.principal}">
					<ul class="navbar-nav">
						...
						<li class="nav-item"><a class="nav-link" href="/blog/user/joinForm">会員登録</a>
					</ul>
				</c:when>
				<c:otherwise>
					<ul class="navbar-nav">
						<li class="nav-item"><a class="nav-link" href="/blog/board/writeForm">글쓰기</a></li>
						<li class="nav-item"><a class="nav-link" href="/blog/user/userForm">会員情報</a>
						<li class="nav-item"><a class="nav-link" href="/blog/user/logout">ログアウト</a>
					</ul>
				</c:otherwise>
			</c:choose>
		</div>
