...
<style>
header.masthead {
	background-image: url('${pageContext.request.contextPath}/images/10.jpg');
...
<header class="masthead">
    <p style="font-size: 60px; color: black; font-weight: bold;">豊年祭について</p>
</header>
<br /><br />
<div class="container container-custom3" style="text-align: center;">
	...
	<br />
	<h3 class="highlighted-text2">【18日】道ズネー/16:00～、舞台/18:00～</h3>
	<br />
	<br />
